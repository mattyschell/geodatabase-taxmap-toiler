...
REM SDEFILE=C:\xxx\Yyyyyyyyyyy\zzzzzzzzz\aaa\bbb-bbbbbbbb\dof_taxmap.sde
REM PYTHONPATH=C:\xxx\geodatabase-toiler\src\py;C:\xxx\geodatabase-taxmap-toiler\src\py%PYTHONPATH%
